...
# Train the model with 60:20:20 split ratio
...
train_idx, val_idx, _, _ = train_test_split(train_val_idx, BldType[train_val_idx], stratify=BldType[train_val_idx], test_size=0.25, random_state=42)
...
architecture_file_path = "/scratch/network/ao3526/Results/FA2021/60_20_20/model_architecture.txt"
...
# Training the model
with open("/scratch/network/ao3526/Results/FA2021/60_20_20/loss_log.txt", "w") as log_file:
    train_losses = []
    val_losses = []
    ...
    for epoch in range(EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(combined_model.state_dict(), "/scratch/network/ao3526/Results/FA2021/60_20_20/Best_Stratified_Sample.pth")
        else:
    ...
    plt.legend()
    plt.savefig("/scratch/network/ao3526/Results/FA2021/60_20_20/BasedOnBldType.png")
    plt.show()
