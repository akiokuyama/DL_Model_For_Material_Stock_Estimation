...
# Train the model with 90:5:5 split ratio
...
architecture_file_path = "/scratch/network/ao3526/Results/FA2021/90_5_5/model_architecture.txt"
...
# Training the model
with open("/scratch/network/ao3526/Results/FA2021/90_5_5/loss_log.txt", "w") as log_file:
    train_losses = []
    val_losses = []
    ...
    for epoch in range(EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(combined_model.state_dict(), "/scratch/network/ao3526/Results/FA2021/90_5_5/Best_Stratified_Sample.pth")
        else:
    ...
    plt.legend()
    plt.savefig("/scratch/network/ao3526/Results/FA2021/90_5_5/BasedOnBldType.png")
    plt.show()
