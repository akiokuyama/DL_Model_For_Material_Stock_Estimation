...
# Train the ViT model with 80:10:10 split ratio
...
# Training the model
with open("/scratch/gpfs/ao3526/Results/FA/ViT/80_10_10/loss_log.txt", "w") as log_file:
    for epoch in range(EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(combined_model.state_dict(), "/scratch/gpfs/ao3526/Results/FA/ViT/80_10_10/Best_Stratified_Sample.pth")
        else:
    ...
    plt.legend()
    plt.savefig("/scratch/gpfs/ao3526/Results/FA/ViT/80_10_10/BasedOnBldType.png")
    plt.show()
