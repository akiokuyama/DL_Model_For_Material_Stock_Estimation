...
architecture_file_path = "/scratch/gpfs/ao3526/Results/BldType/ViT/80_10_10/model_architecture.txt"
...
# Training the model
with open("/scratch/gpfs/ao3526/Results/BldType/ViT/80_10_10/loss_log.txt", "w") as log_file:
    for epoch in range(EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            epochs_without_improvement = 0
            torch.save(combined_model.state_dict(), "/scratch/gpfs/ao3526/Results/BldType/ViT/80_10_10/Best_Combined_model.pth")
        else:
    ...
    plt.legend()
    plt.savefig("/scratch/gpfs/ao3526/Results/BldType/ViT/80_10_10/Combined_Model.png")
    plt.show()
...
np.save("/scratch/gpfs/ao3526/Results/BldType/ViT/80_10_10/train_confusion_matrix.npy", cm_train)
cm_val = confusion_matrix(all_val_labels, all_val_predictions)
np.save('/scratch/gpfs/ao3526/Results/BldType/ViT/80_10_10/test_confusion_matrix.npy', cm_val)  # Saving the confusion matrix
...
plt.savefig('/scratch/gpfs/ao3526/Results/BldType/ViT/80_10_10/train_confusion_matrix.png')

plt.figure(figsize=(10, 10))
plot_confusion_matrix(cm_val, classes=validation_label_encoder.classes_, title='Validation Confusion Matrix')
plt.savefig('/scratch/gpfs/ao3526/Results/BldType/ViT/80_10_10/validation_confusion_matrix.png')