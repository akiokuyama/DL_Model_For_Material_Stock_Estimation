...
train_idx, val_idx, _, _ = train_test_split(train_val_idx, BldType[train_val_idx], stratify=BldType[train_val_idx], test_size=0.0526, random_state=42) # 0.25 * 0.8 = 0.2
...
architecture_file_path = "/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/model_architecture.txt"
...
# Training the model
with open("/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/loss_log.txt", "w") as log_file:
    for epoch in range(EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(combined_model.state_dict(), "/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/Best_Combined_model.pth")
        else:
    ...
    plt.legend()
    plt.savefig("/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/Combined_Model.png")
    plt.show()


# Confusion Matrix for Training and Validation Data
cm_train = confusion_matrix(all_train_labels, all_train_predictions)
np.save("/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/train_confusion_matrix.npy", cm_train)
cm_val = confusion_matrix(all_val_labels, all_val_predictions)
np.save('/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/test_confusion_matrix.npy', cm_val)  # Saving the confusion matrix
...
plt.savefig('/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/train_confusion_matrix.png')

plt.figure(figsize=(10, 10))
plot_confusion_matrix(cm_val, classes=validation_label_encoder.classes_, title='Validation Confusion Matrix')
plt.savefig('/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/validation_confusion_matrix.png')


# Load the best model weights before evaluation
best_model_path = "/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/Best_Combined_model.pth"
...
metrics_file_path = "/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/test_metrics.txt"
...
np.save('/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/test_confusion_matrix.npy', cm_test)
...
plt.savefig('/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/test_confusion_matrix.png')
...
results_csv_path = "/scratch/network/ao3526/Results/BldType/CNN_ResNet18/90_5_5/Results.csv"
